      ...
      <div class="w-96 border flex flex-col items-center gap-y-10 p-5 rounded-md shadow-md px-10 bg-white">
        ...
        <div class="w-full flex flex-col items-center gap-y-3">
          <div class="flex flex-col w-full">
            ...
            <input type="email" name="email" id="email" class="border rounded-md w-full py-1 px-1" />
          </div>
          <div class="flex flex-col w-full">
            <label class="text-slate-600" for="username">Password</label>
            <input type="password" name="password" id="password" class="border rounded-md w-full py-1 px-1" />
          </div>
          <div class="flex flex-col w-full">
            <label class="text-slate-600" for="username">Confirm Password</label>
            <input type="password" name="confirmPassword" id="confirmPassword" class="border rounded-md w-full py-1 px-1" />
          </div>
        </div>
        <button class="bg-[#EB6648] text-white w-full rounded-md py-1.5">submit</button>
